...
/**
 * @brief 从JSON字符串 BUF 中获取用户信息、MD5和文件名
 * @param buf [in] 包含JSON字符串的缓冲区
 * @param user [out] 用于存储解析出的用户名的字符数组
 * @param md5 [out] 用于存储解析出的文件MD5的字符数组
 * @param filename [out] 用于存储解析出的文件名的字符数组
 * @return 0表示成功，-1表示解析过程中遇到错误
 */
